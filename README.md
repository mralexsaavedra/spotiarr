...
| ----------------------- | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DB_PATH                 | `./config/db.sqlite`      | Path where SpotiArr database will be stored (relative to project root)                                                                                                                                                                                      |
| FE_PATH                 | `./dist/frontend/browser` | Path to frontend build output (relative to project root)                                                                                                                                                                                                    |

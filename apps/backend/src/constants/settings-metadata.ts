...
export const SETTINGS_METADATA: Record<string, SettingMetadata> = {
  ...
  SEARCH_MAX_ATTEMPTS: {
    ...
    description:
      "How many times to retry finding a track on YouTube before marking it permanently failed.",
  },
  RECOVERY_JOB_INTERVAL_MINUTES: {
    key: "RECOVERY_JOB_INTERVAL_MINUTES",
    defaultValue: "5",
    type: "number",
    component: "input",
    section: "Downloads",
  ...
  AI_API_KEY: {
    ...
    secret: true,
    label: "AI API Key",
    description: "The API key for the AI provider. Stored securely and masked on read.",
  },
  AI_MODEL: {
    key: "AI_MODEL",
    defaultValue: "",
